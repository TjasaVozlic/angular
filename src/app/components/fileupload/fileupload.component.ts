...
export class FileuploadComponent implements OnInit{
  ...
  constructor(private fileService: FileService, private fireStorage: AngularFireStorage, private dataService : ServiceDataService) { }
  ...
  uploadFile() {
     this.currentFileUpload =  new FileData(this.selectedFiles[0]);
